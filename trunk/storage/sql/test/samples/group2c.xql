...
>
  ...
  <table name="group" connection="test">
    ...
    <reference name="users_main" table="user:user7" foreign="user:group_main" import="user7.xql"/>
    <reference name="users_sub" table="user:user7" foreign="user:group_sub" import="user7.xql"/>
