...
*/
    ...
    if ($aResult) {
      ...
      $sContent = $window->createString($aResult);
      $sKey = $window->createString(uniqid());

      $result = $this->getContext()->call('add', array(array($sKey, $sContent)), '\sylma\core\window\context', false);
    }
    else {
