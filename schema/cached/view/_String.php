...
*/
   ...
   */
  protected static function urlize($sValue) {
    ...
    $sResult = strtolower(preg_replace(array('/[^a-zA-Z0-9 -]/', '/[ -]+/', '/^-|-$/'), array('', '-', ''), str_replace($aFind, $aReplace, $sValue)));
