...
define('SYLMA_HTML_TAGS', '//html:div | //html:span | //html:a | //html:ul | //html:h2 | //html:iframe | //html:textarea | //html:script | //html:table');
...
$aExecutableExtensions = array('', 'eml', 'htm', 'html', 'xml', 'txt', 'popup', 'action', 'rss', 'sylma', 'redirect');
